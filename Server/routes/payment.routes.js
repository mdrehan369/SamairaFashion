...
router.route('/tabby/check/:id').get(verifyJWT, retrieveTabbyCheckoutController, clearCartAndPlaceOrderController);
router.route('/ziina/pay').post(verifyJWT, ziinaCheckoutController);
router.route('/ziina/check/:id').get(verifyJWT, retrieveZiinaCheckoutController, clearCartAndPlaceOrderController);
