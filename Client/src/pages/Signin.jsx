    ...
    return (
        <Container className='flex flex-col items-center justify-center gap-8 relative'>
            ...
            <form onSubmit={handleSubmit(submit)} className='flex flex-col items-center justify-center gap-4 md:w-[25%] w-[80%]'>
                <Input type="text" name='email' register={register} placeholder='ex. john123@example.com' required className='w-full' label='Email' />
                <Input type={showPass ? "text" : "password"} name='password' register={register} placeholder='8+ Characters' className='w-full' label='Password' required />
                ...
                <Button disabled={loader} className='p-0 w-52 h-16 uppercase text-sm font-bold'>
                    {
                        loader ?
                        <LightSpinner />
                        : 'Log In'
