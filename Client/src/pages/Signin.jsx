...
function Signin() {
    ...
    return (
        <Container className='flex items-center justify-center gap-0 relative h-[100vh] w-[100vw] bg-[#fff]'>
            <img src={signin} alt="Stock" className='w-[70%] h-full animate-animate-appear' />
            <div className='w-[30%] flex flex-col relative items-center justify-center gap-10 h-[100%] bg-[#ffefd2] border-l-2 shadow-md border-[rgb(129,30,30)]'>
                {err &&
                    ...
                    !otpPage ?
                        <>
                            ...
                            <form onSubmit={handleSubmit(submit)} className='flex flex-col items-center justify-center gap-4 md:w-[25%] w-[100%]'>
                                <input type="text" {...register('email')} className='w-[20vw] py-3 bg-[#fffcf7] px-4 border-[1px] border-[#ffefd2] text-sm focus:ring-0 focus:border-maroon focus:outline-none' placeholder='Email...' />
                                <Button type='submit' disabled={loader} className='p-0 w-[20vw] bg-[#800000] text-[#ffdfa8] h-12 uppercase text-sm font-bold'>
                                    {
                                        loader ?
                            ...
                            <div className='space-y-4'>
                                <button className="flex items-center bg-[#fffcf7] dark:bg-gray-900 border-gray-300 rounded-md shadow-sm w-[20vw] justify-center py-3 text-sm font-medium text-gray-800 border-0 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-500" onClick={Glogin}>
                                ...
                                <button className='flex items-center bg-[#fffcf7] dark:bg-gray-900 border-0 border-gray-300 rounded-md shadow-sm w-[20vw] justify-center py-3 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-500'>
                                    <FontAwesomeIcon icon={faFacebook} className='mr-2 text-blue-500 size-6' />
                                    Continue With Facebook</button>

                                <button className="flex items-center bg-[#fffcf7] dark:bg-gray-900 border-0 border-gray-300 rounded-md shadow-sm w-[20vw] justify-center py-3 text-sm font-medium text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-500" onClick={() => navigate('/')}>Continue Without Login</button>
                            </div>
                        </> :
