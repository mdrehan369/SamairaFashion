...
const Privacy = () => {
    return (
        <Container className="p-4 w-[70%] mx-auto prose text-sm font-[400] animate-animate-appear">
            ...
            <h2 className="text-2xl font-semibold mt-6 mb-4">How We Collect and Use Your Personal Information</h2>
            <p>
                To provide the Services, we collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us.
            </p>

            <h3 className="text-xl font-semibold mt-4 mb-2">What Personal Information We Collect</h3>
            <p>
                The types of personal information we obtain about you depends on how you interact with our Site and use our Services. When we use the term "personal information", we are referring to information that identifies, relates to, describes or can be associated with you. The following sections describe the categories and specific types of personal information we collect.
            </p>

            <h4 className="text-lg font-semibold mt-4 mb-2">Information We Collect Directly from You</h4>
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2">Information We Collect through Cookies</h4>
            <p>
            ...
            <h4 className="text-lg font-semibold mt-4 mb-2">Information We Obtain from Third Parties</h4>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">How We Use Your Personal Information</h3>
            <ul className="list-disc list-inside ml-4">
                <li>
                ...
                <li>
                    <strong>Communicating with you:</strong> We use your personal information to provide you with customer support and improve our Services. This is in our legitimate interests to be responsive to you, provide effective services to you, and maintain our business relationship with you.
                </li>
            </ul>

            <h3 className="text-xl font-semibold mt-4 mb-2">Cookies</h3>
            <p>
                Like many websites, we use Cookies on our Site. For specific information about the Cookies that we use related to powering our store with Shopify, see <a href="https://www.shopify.com/legal/cookies" className="text-blue-500 hover:underline">https://www.shopify.com/legal/cookies</a>. We use Cookies to power and improve our Site and our Services (including to remember your actions and preferences), to run analytics and better understand user interaction with the Services (in our legitimate interests to administer, improve and optimize the Services). We may also permit third parties and services providers to use Cookies on our Site to better tailor the services, products and advertising on our Site and other websites.
            </p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">How We Disclose Personal Information</h3>
            <p>
            ...
            <p>
                We have, in the past 12 months disclosed the following categories of personal information and sensitive personal information (denoted by *) about users for the purposes set out above in "<strong>How we Collect and Use your Personal Information</strong>" and "<strong>How we Disclose Personal Information</strong>":
            </p>
            ...
            <table className="border-collapse w-full mb-6">
                <thead>
                    <tr>
                        ...
                        <th className="border p-2">Categories of Recipients</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">Third Party Websites and Links</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">Children’s Data</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">Security and Retention of Your Information</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mt-4 mb-2">International Users</h3>
            <p>
